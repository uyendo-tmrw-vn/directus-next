  ...
  return (
    <>
      ...
      <div className="bg-gray-200 font-sans leading-normal tracking-normal">
        ...
        {/* <!--Header--> */}
        <div className="w-full m-0 p-0 bg-cover bg-bottom" style={{ backgroundImage: "url('https://www.tailwindtoolbox.com/templates/cover.jpg')", height: '60vh', maxHeight: '460px' }}>
          ...
          <div className="mx-0 sm:mx-6">
            ...
            <nav className="mt-0 w-full">
              <div className="container mx-auto flex items-center">
                ...
                <div className="flex w-1/2 justify-end content-center">
                  <Link className="inline-block text-gray-500 no-underline hover:text-white hover:text-underline text-center h-10 p-2 md:h-auto md:p-4 avatar" data-tippy-content="@twitter_handle" href="https://twitter.com/intent/tweet?url=#">
                  ...
                  <Link className="inline-block text-gray-500 no-underline hover:text-white hover:text-underline text-center h-10 p-2 md:h-auto md:p-4 avatar" data-tippy-content="#facebook_id" href="https://www.facebook.com/sharer/sharer.php?u=#">
                ...
                {/* <!--1/3 col --> */}
                {
                  listBlogs && listBlogs.length && listBlogs.map((item, key) => {
                    return <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                      <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
                        <div className="flex flex-wrap no-underline hover:no-underline flex-col">
                          <img src={`${process.env.NEXT_PUBLIC_GRAPHQL}/assets/${item?.image}`} className="h-64 w-full rounded-t pb-6" />
                          <div className='p-6'>
                            <p className="w-full text-gray-600 text-xs md:text-sm">{item.date_created}</p>
                            <Link href={`/blog-detail/${item.id}`}>
                              <a className="w-full font-bold text-xl text-gray-900 d-block">{item.title}</a>
                            </Link>
                            <div className="flex items-center justify-between mt-5">
                              <img className="w-8 h-8 rounded-full mr-4 avatar" data-tippy-content="Author Name" src="http://i.pravatar.cc/300" alt="Avatar of Author" />
                              <p className="text-gray-600 text-xs md:text-sm">{item.status}</p>
                            </div>
                          </div>
            ...
            <div className="flex w-full items-center font-sans p-8 md:p-24">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-600 text-xs md:text-base">Tailwind CSS version of Ghost's Casper theme by
                  <Link className="text-gray-800 hover:text-green-500 no-underline border-b-2 border-green-500" href="https://www.tailwindtoolbox.com">TailwindToolbox.com</Link></p>
              </div>
